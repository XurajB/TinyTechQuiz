...
/**
 * Created by surajbhattarai on 9/20/15.
 */
public class QuizListenerService extends WearableListenerService {
    private static final String TAG = "TinyTechQuizService";
    private static final int QUIZ_REPORT_NOTIF_ID = -1;
    ...
    public void onDataChanged(DataEventBuffer dataEvents) {
        ...
        ConnectionResult connectionResult = googleApiClient.blockingConnect(Constants.CONNECT_TIMEOUT_MS,
